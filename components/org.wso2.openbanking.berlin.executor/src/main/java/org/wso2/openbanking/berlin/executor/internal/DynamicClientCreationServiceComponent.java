...
public class DynamicClientCreationServiceComponent {

    private static final Log log = LogFactory.getLog(DynamicClientCreationServiceComponent.class);

    @Activate
    protected void activate(ComponentContext context) {

        log.debug("Open banking Berlin executor component is activated ");
    }

    @Deactivate
    protected void deactivate(ComponentContext context) {

        log.debug("Open banking Berlin executor component is deactivated ");
    }
    ...
    public void setConfigService(OpenBankingConfigurationService openBankingConfigurationService) {
        ...
        DynamicClientCreationDataHolder.getInstance()
    ...
    public void unsetConfigService(OpenBankingConfigurationService openBankingConfigurationService) {
        ...
        DynamicClientCreationDataHolder.getInstance().setOpenBankingConfigurationService(null);
    }
    ...
    public void setAPIMConfig(APIManagerConfigurationService apManagerConfigurationService) {
        ...
        DynamicClientCreationDataHolder.getInstance().setApiManagerConfiguration(apManagerConfigurationService);
    }
