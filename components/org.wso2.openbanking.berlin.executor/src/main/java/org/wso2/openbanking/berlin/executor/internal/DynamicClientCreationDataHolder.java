 ...
 */
public class DynamicClientCreationDataHolder {

    private static volatile DynamicClientCreationDataHolder instance;
    ...
    private DynamicClientCreationDataHolder() {

    }

    public static DynamicClientCreationDataHolder getInstance() {

        if (instance == null) {
            synchronized (DynamicClientCreationDataHolder.class) {
                if (instance == null) {
                    instance = new DynamicClientCreationDataHolder();
                }
            }
        }
        return instance;
    ...
    private Map<String, Object> constructURLMap() {
        ...
        String iamHostName = DynamicClientCreationDataHolder.getInstance()
